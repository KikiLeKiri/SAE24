...
def on_message(client, userdata, msg):
    ...
    Donnee_colone = str("("+colone[0]+","+colone[2]+","+colone[3]+","+colone[4]+")")
    Donnee_valeur = str("('"+valeur[0]+"','"+valeur[2]+"','"+valeur[3]+"',"+valeur[4]+")")
    # Prepare dynamic SQL statement
    sql= "INSERT INTO Donnee "+Donnee_colone+" VALUES "+Donnee_valeur+";"
    print(sql)
